...
Then build the whole package by going to ros2 by ignoring octomap_msgs and octomap_server2

```bash
colcon build --packages-ignore octomap_msgs octomap_server octomap_mapping
```
