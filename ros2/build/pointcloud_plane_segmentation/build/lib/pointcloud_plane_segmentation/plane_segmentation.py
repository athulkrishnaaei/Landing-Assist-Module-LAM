...
class PlaneDetectionNode(Node):
    ...
    def ransac_plane_segmentation(self, cloud):
        self.get_logger().info(f'Running ranac plane segmentation')
...
def main(args=None):
    ...
    # parser.add_argument('method', help='Plane segmentation method to perform', choices=['ransac', 'prosac'])
    # parsed_args = parser.parse_args(rclpy.utilities.remove_ros_args(args))
