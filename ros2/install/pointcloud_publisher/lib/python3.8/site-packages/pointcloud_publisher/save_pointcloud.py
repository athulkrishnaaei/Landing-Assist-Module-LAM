"""
This method is for saving the point cloud 
and another node called save_pointcloud_publisher will publish
Pointcloud and it will be passed to save_pointcloud_plane_seg for
plane segmentation the idea was to process saved pointcloud for plane
segmentation because it has good output,this method can be tested in 
future for better output
"""
import rclpy
